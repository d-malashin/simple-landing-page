...
import quoteImageSrc from "./assets/images/Quote_Image.png";

const imageSetter = () => {
  console.log(heroImageSrc, bigFeatureSrc, quoteImageSrc);
  document.querySelector(".review__image").src = quoteImageSrc;
